            ...
            <div class="col-md-12 p-0">
                <div class="main-content">
                    <div id="create-payslip-view">
                        <form method="POST" action="{{ route('slips.store') }}">
                            @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="month" id="payslip-period" name="period" class="form-control" value="{{ old('period') }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                            ...
                                            <table class="table table-bordered" id="earnings-table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" name="earnings[0][amount]" class="form-control earning-amount" value="5000000">
                                                        </td>
                                        ...
                                        <div class="tab-pane fade" id="deductions-content">
                                            ...
                                            <table class="table table-bordered" id="deductions-table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="text" name="deductions[0][name]" class="form-control" value="BPJS Kesehatan" required>
                                                        </td>
                                                        <td>
