...
<head>
  ...
  <style>
    ...
    /* supaya tabel tetap rapi */
    .table { table-layout: fixed; }
    .table th, .table td { white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    .table th.alasan, .table td.alasan { width: 25%; white-space: normal; }
  </style>
</head>
<body>
<div class="container py-4">
  ...
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div>
      <a href="{{ route('cuti.sisa.index') }}" class="btn btn-info me-2">
        <i class="bi bi-clock-history me-1"></i> Rekap Sisa Cuti
      </a>
