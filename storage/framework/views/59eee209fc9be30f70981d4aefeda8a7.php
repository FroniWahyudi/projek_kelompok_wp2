...
<main>
  ...
  <div class="row g-3">
    <?php $__currentLoopData = $newsItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php
        $total = count($newsItems);
        $col = ($idx >= $total - 2) ? 'col-md-6' : 'col-md-3';
      ?>
      <div class="col-12 col-sm-6 <?php echo e($col); ?>">
        <a href="<?php echo e(route('whats_new', ['id' => $item['id']])); ?>"
           class="text-decoration-none text-reset">
          <div class="card card-news shadow-sm h-100">
            <img src="<?php echo e(htmlspecialchars($item['image_url'])); ?>"
                 class="card-img-top"
                 alt="<?php echo e(htmlspecialchars($item['title'])); ?>">
            <div class="card-body">
              <h6 class="fw-bold"><?php echo e(htmlspecialchars($item['title'])); ?></h6>
              <small class="text-muted"><?php echo e(htmlspecialchars($item['date'])); ?></small>
              <p class="small"><?php echo e(Str::limit($item['description'], 100)); ?></p>
            </div>
          </div>
        </a>
      </div>
...
<?php /**PATH C:\xampp\htdocs\codepolitan\projek_wp2\resources\views/index/dashboard.blade.php ENDPATH**/ ?>