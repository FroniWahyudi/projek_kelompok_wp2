...
<head>
  <meta charset="UTF-8">
  <title><?php echo e($item['title']); ?> – What's New</title>
...
<body>
  <div class="container-fluid">
    ...
    <div class="card">
      <img src="<?php echo e(asset($item['image_url'])); ?>" class="card-img-top" alt="<?php echo e($item['title']); ?>">
      <div class="card-body">
        <h2 class="card-title"><?php echo e($item['title']); ?></h2>
        <p class="text-muted"><?php echo e($item['date']); ?></p>
        <p class="card-text">
          <span id="short-text"><?php echo $shortDesc; ?><?php echo e($isLong ? '...' : ''); ?></span>
          <?php if($isLong): ?>
            <span id="full-text" style="display:none;"><?php echo $fullDesc; ?></span>
          <?php endif; ?>
        </p>
        <?php if($isLong): ?>
          <button id="read-more" class="btn btn-primary">Baca selengkapnya</button>
        <?php elseif(!empty($item['link'])): ?>
          <a href="<?php echo e($item['link']); ?>" class="btn btn-primary">Baca selengkapnya</a>
        <?php endif; ?>
      </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\codepolitan\projek_wp2\resources\views/index/whats_new.blade.php ENDPATH**/ ?>